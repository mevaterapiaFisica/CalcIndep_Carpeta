...
{
    public static class crearInforme
    {
        ...
        public static void Informe(Patient paciente, PlanSetup plan, List<Structure> estructuras, bool _hayContext)
        {
        ...
        /*   public static Tuple<int, int> hallarPrimerBlanco1Abajo(Tuple<int, int> primerBlanco2)
           {
               return new Tuple<int, int>(primerBlanco2.Item1, primerBlanco2.Item2 - 21);
           }*/
        ...
        public static bool obtenerImagenes(Bitmap imagen)
        {
        ...
        public static Course Curso (Patient paciente, PlanningItem plan)
        {
            ...
            {
                return paciente.Courses.Where(c => c.PlanSetups.Contains(plan)).First();
            }
            else
            {
                return paciente.Courses.Where(c => c.PlanSums.Contains(plan)).First();
            }
        }
        ...
        public static Paragraph PrimerParrafo(Patient paciente, PlanSetup plan)
        {
            ...
            else if (plan.Beams.First().MLCPlanType == MLCPlanType.VMAT)
            {
            ...
            primerParrafo.AddText(" realizó tratamiento radiante " + textoTipoTratamiento + " con una dosis de prescripción de " + plan.TotalPrescribedDose.Dose.ToString() + "cGy en " + plan.UniqueFractionation.NumberOfFractions.ToString() + " fracciones. En el presente informe se adjunta corte axial en isocentro de la lesión y planificación del tratamiento (Figura 1). Las curvas representan niveles de dosis en Gy, indicados con diferentes colores.");
        ...
        public static MigraDoc.DocumentObjectModel.Tables.Table TablaDVH(PlanSetup plan, List<Structure> estructuras)
        {
        ...
        public static Document informe(Patient paciente, PlanSetup plan, Bitmap imagen, List<Structure> estructuras)
        {
        ...
        public static Document informe(Patient paciente, PlanSetup plan, List<Structure> estructuras)
        {
            ...
            {
                var axial = seccion.AddImage(paciente.Id + "_axial.png");
                axial.Width = new Unit(14, UnitType.Centimeter);
                axial.Left = MigraDoc.DocumentObjectModel.Shapes.ShapePosition.Center;
                ...
                imagenes.AddRow();
                imagenes.Rows.LeftIndent = "1cm";
                var coronal = imagenes.Rows[0].Cells[0].AddImage(paciente.Id + "_coronal.png");
                coronal.Width = new Unit(8.5, UnitType.Centimeter);
